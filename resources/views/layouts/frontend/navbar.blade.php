        ...
        <div class="main-bar clearfix ">
            <div class="container-fluid clearfix">
                ...
                <div class="logo-header mostion logo-dark">
                    <a href="front-dashboard.html"><img src="/frontend/images/logo-text.png" alt=""></a>
                </div>
                <!-- Nav Toggle Button -->
                ...
                <div class="extra-nav dropdown">
                    <div class="extra-cell">
                        <a href="javascript:void();" role="button" data-bs-toggle="dropdown" class="profile-box">
                            <div class="header-info">
                                <span>{{ Auth::user()->name }}.</span>
                                <small>Super Admin</small>
                            </div>
                            <div class="img-bx">
                                <img src="/frontend/images/avatar/1.jpg" alt="">
                            </div>
                        </a>
                ...
                <div class="extra-nav">
                    <div class="extra-cell">
                        <a href="{{ route('register') }}" class="profile-box">
                                <span>Register</span>
                        </a>
                    </div>
                </div>
                ...
                <div class="extra-nav">
                    <div class="extra-cell">
                        <a href="{{ route('login') }}" class="profile-box">
                                <span>Login</span>
                        </a>
                    </div>
                </div>
                ...
                <div class="header-nav navbar-collapse collapse" id="navbarNavDropdown">
                    ...
                    <ul class="nav navbar-nav navbar navbar-left">
                        <li class=""><a href="{{ route('home.index') }}">
                        ...
                        CATEGORY</a></li>
                        <li class=""><a href="{{ route('menu.index') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <rect x="0" y="0" width="24" height="24"/>
                        ...
                        MENU</a></li>
                        <li class=""><a href="{{ route('reservation.one') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <rect x="0" y="0" width="24" height="24"/>
