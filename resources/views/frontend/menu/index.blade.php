                            ...
                            <div class="table-responsive">
                                <table class="table text-black">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><span class="font-w500">{{ $menu->name }}</span></td>
                                            <td>{{ $menu->price }}</td>
                                            <td>
                    ...
                    <div class="col-xl-3 col-xxl-4 col-lg-6 col-md-12 col-sm-6">
                        <div class="card item-card">
                            <div class="card-body p-0">
                                ...
                                <div class="info">
                                    <h5 class="name">{{ $menu->name }}</h5>
                                    <p class="mb-0 mt-2 price"><img src="/images/veg.png" alt="">{{ $menu->description }}<h6>
                                </div>
                            </div>
                            <div class="div">
                                <a href="" type="btn" class="btn btn-warning btn-sm mb-3 ms-3">RP. {{ $menu->price }}</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
