                    ...
                    <div class="card">
                        ...
                        <div class="card-body pt-3">
                            ...
                            <div class="media mb-3 pb-3 items-list-2 align-items-center">
                                <a href="javascript:void(0);"><img class="img-fluid rounded me-3" width="85" src="{{ Storage::url($menu->image) }}" alt="DexignZone"></a>
                                <div class="media-body col-6 px-0">
                                    <h3 class="mt-0 mb-3 sub-title">{{ $menu->name }}</h3>
                                ...
                                <div class="media-footer align-self-center ms-auto d-block align-items-center d-sm-flex">
                                    <h3	class="mb-0 font-w600 text-secondary">RP. {{ $menu->price }}</h3>
